## navigation (kinetic) - 1.14.9-1

The packages in the `navigation` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic navigation` on `Tue, 05 Jan 2021 18:06:31 -0000`
...
## navigation (noetic) - 1.17.1-1

The packages in the `navigation` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic navigation` on `Thu, 27 Aug 2020 15:14:31 -0000`
...
## navigation (melodic) - 1.16.7-1

The packages in the `navigation` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic navigation` on `Thu, 27 Aug 2020 14:56:52 -0000`
...
- upstream repository: https://github.com/ros-planning/navigation.git
- release repository: https://github.com/ros-gbp/navigation-release.git
- rosdistro version: `1.16.6-1`
- old version: `1.16.6-1`
- new version: `1.16.7-1`
...
## navigation (kinetic) - 1.14.8-1

The packages in the `navigation` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic navigation` on `Thu, 27 Aug 2020 14:39:35 -0000`
...
- upstream repository: https://github.com/ros-planning/navigation.git
- release repository: https://github.com/ros-gbp/navigation-release.git
- rosdistro version: `1.16.4-1`
- old version: `1.16.5-1`
- new version: `1.16.6-1`
...
## navigation (melodic) - 1.16.5-1

The packages in the `navigation` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic navigation` on `Sun, 15 Mar 2020 13:20:04 -0000`
...
- release repository: https://github.com/ros-gbp/navigation-release.git
- rosdistro version: `1.16.4-1`
- old version: `1.16.4-1`
- new version: `1.16.5-1`
...
## navigation (kinetic) - 1.14.7-1

The packages in the `navigation` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic navigation` on `Tue, 10 Mar 2020 15:07:54 -0000`
